...
const string strMessageMagic = "StopTrumpCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StopTrumpCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "NY TIMES Jan 29 2017 WHITE HOUSE SCALES BACK IMMIGRATION BAN";
        CTransaction txNew;
        txNew.nTime = 1485771310;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1485771310;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 265798 : 265798;
        ...
        assert(block.hashMerkleRoot == uint256("0x15c715d7e1489dbe311788b635902d1403920b8f1324cf8bc9b8281b4a45d04a"));
